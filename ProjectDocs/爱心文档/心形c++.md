...
![](https://liuliutuku.oss-cn-hangzhou.aliyuncs.com/tupian0/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20230927204653.png)
...
注意，虽然源码是c语言，但由于图形库是c++编写的，所以需要创建cpp文件才可以运行。c文件目前运行不了

VC++没有接触过，不过运行过程和VS相差不大
VS一般的运行步骤
1下载easyx
2选择安装
3创建新的项目
...
注：本篇笔记转载来源为【C语言爱心代码，`easyx`版（适合visual studio和visual C++）。-哔哩哔哩】 https://b23.tv/or6Htql